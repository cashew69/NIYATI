...
static const AttrDesc kVolumetricCloud[] = {
    ...
    // Weather map generator parameters
    { "wg_patternType",    ATTR_INT,   (int)offsetof(VolumetricCloudNodeData, weatherGen.patternType),    1.0f,  0,       4,       0 },
    { "wg_centerX",        ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.centerX),        0.01f, 0,       1,       0 },
    { "wg_centerY",        ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.centerY),        0.01f, 0,       1,       0 },
    { "wg_arms",           ATTR_INT,   (int)offsetof(VolumetricCloudNodeData, weatherGen.arms),           1.0f,  1,       5,       0 },
    { "wg_tightness",      ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.tightness),      0.1f,  0.1f,    15,      0 },
    { "wg_falloffRadius",  ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.falloffRadius),  0.01f, 0.05f,   0.9f,    0 },
    { "wg_bandAngle",      ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.bandAngle),      0.01f, 0,       6.2832f, 0 },
    { "wg_bandWidth",      ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.bandWidth),      0.01f, 0.05f,   0.95f,   0 },
    { "wg_bandSpacing",    ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.bandSpacing),    0.005f,0.03f,   0.5f,    0 },
    { "wg_bandTurbulence", ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.bandTurbulence), 0.005f,0,       0.3f,    0 },
    { "wg_noiseFreq",      ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.noiseFreq),      0.1f,  0.1f,    8,       0 },
    { "wg_coverageScale",  ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.coverageScale),  0.01f, 0.1f,    1,       0 },
    { "wg_coverageMin",    ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.coverageMin),    0.01f, 0,       0.9f,    0 },
    { "wg_coverageMax",    ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.coverageMax),    0.01f, 0.1f,    1,       0 },
    { "wg_texResolution",  ATTR_INT,   (int)offsetof(VolumetricCloudNodeData, weatherGen.texResolution),  1.0f,  0,       2,       0 },
    { "wg_worldAnchorX",   ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.worldAnchorX),   10.0f, -1e6f,   1e6f,    0 },
    { "wg_worldAnchorZ",   ATTR_FLOAT, (int)offsetof(VolumetricCloudNodeData, weatherGen.worldAnchorZ),   10.0f, -1e6f,   1e6f,    0 },
    { "wg_followCamera",   ATTR_BOOL,  (int)offsetof(VolumetricCloudNodeData, weatherGen.followCamera),   0,     0,       0,       0 },
    // Noise layer toggles
    { "useBaseNoise",      ATTR_BOOL,  (int)offsetof(VolumetricCloudNodeData, useBaseNoise),              0,     0,       0,       0 },
    { "useWorleyErosion",  ATTR_BOOL,  (int)offsetof(VolumetricCloudNodeData, useWorleyErosion),          0,     0,       0,       0 },
    { "useDetailNoise",    ATTR_BOOL,  (int)offsetof(VolumetricCloudNodeData, useDetailNoise),            0,     0,       0,       0 },
    // Atmospheric fog
